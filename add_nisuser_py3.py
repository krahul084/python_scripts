#!/usr/bin/python
import getpass,sys,os, subprocess,hashlib
...
def gather_info():
	username = input('Please enter username(Within 8 chars): ')
	password = getpass.getpass('Please enter password: ')
	gid = input('Enter GID: ')
	description = input('Please enter user description: ')
	filer = input("Please enter the VNX filer for home_directory: ")
...
if __name__ == '__main__':
	...
	home_filer = 'vnx_01:/%s/home/&' % filer
        ...
        confirmation = input('Hit(Y/y) to commit! ')
